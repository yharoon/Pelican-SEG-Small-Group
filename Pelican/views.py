...
def dashboard(request):
    ...
    Displays user's tasks, teams, and notifications.
    Also handles the creation of new teams.
...
def team_detail(request, team_id):
    ...
    Displays team information and tasks, and handles task creation.
...
def remove_member(request, team_id, member_id):
    ...
    """
    View to handle the removal of a member from a team.
    """
    team = get_object_or_404(Team, pk=team_id)
...
def clear_received_invitations(request):
    ...
    """
    View to clear all received invitations for the logged-in user.
    """
...
def reset_user_data(request):
    ...
    """
    View to reset user data, including deleting user's teams and invitations.
    """
...
def send_invitations(request, team_id):
    """
    View to send invitations to users for joining a team.
    Handles the selection and invitation of users.
    """
...
def accept_invitation(request, invitation_id):
    """
    View to accept an invitation to join a team.
    """
...
def reject_invitation(request, invitation_id):
    """
    View to reject an invitation to join a team.
    """   
...
def confirm_invitation(request, invitation_id):
    """
    View to confirm the acceptance or rejection of an invitation.
    Deletes the associated notification upon action.
    """ 
...
class LoginProhibitedMixin:
    ...
    """
    Mixin to redirect authenticated users away from views meant for unauthenticated users.
    """
...
class TeamCreateView(LoginRequiredMixin, FormView):
    ...
    Handles the display and processing of the team creation form.
    """
    # Specifies the HTML template to be used for rendering the team creation page.
    template_name = 'team.html'
    # Assigns 'TeamForm' as the form class to be used for creating a team.
    form_class = TeamForm

    def get_context_data(self, **kwargs):
        """
        Overrides the method to add additional context data for rendering the template.
        
        This method retrieves a list of users based on the search term provided in the request.
        It allows the user creating the team to search for and add members to the team.
        """   
        
        # Retrieves the search term from the GET request.
        context = super().get_context_data(**kwargs)
        
        
        search_term = self.request.GET.get('userSearch')
        # Filters the User objects based on the search term, 
        # searching across username, first name, and last name.
        ...
        # Adds the list of users to the context dictionary.
        context['users'] = users
    ...
    def form_valid(self, form):
        ...
        """
        Overrides the method to define what happens when the form is valid.

        It handles the creation of a new team with the specified name and members.
        """
        
        # Retrieves the team name from the validated form data.
        team_name = form.cleaned_data['name']
        # Retrieves the selected members from the validated form data.
        selected_members = form.cleaned_data['members']
        # Creates a new Team instance with the provided name.
